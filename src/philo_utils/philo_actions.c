...
/*   Updated: 2024/02/22 15:40:31 by mhaile           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		// printf(" 1          %d           \n", philo->id);
// 		pthread_mutex_lock(&philo->data->mutex_test);
// 		if (philo->data->forks_taken[philo->id * 2 - 2] == 0)
// 		{
// 			pthread_mutex_unlock(&philo->data->mutex_test);
// 			pthread_mutex_lock(philo->left_fork);
// 			philo->data->forks_taken[philo->id * 2 - 2] = 1;
// 		}
// 		else
// 		{
// 			pthread_mutex_unlock(&philo->data->mutex_test);
...
// 		}
// 		pthread_mutex_lock(&philo->data->mutex_test);
// 		if (philo->data->forks_taken[philo->id * 2 - 1] == 0)
// 		{
// 			pthread_mutex_unlock(&philo->data->mutex_test);
// 			pthread_mutex_lock(philo->right_fork);
// 			philo->data->forks_taken[philo->id * 2 - 1] = 1;
// 		}
// 		else
// 		{
// 			// printf("NETO\n");
...
// 		pthread_mutex_unlock(philo->right_fork);
// 		pthread_mutex_unlock(philo->left_fork);
// 		philo->data->forks_taken[philo->id * 2 - 2] = 0;
// 		philo->data->forks_taken[philo->id * 2 - 1] = 0;
// 			// return (1);
// 	}
// 	else
// 	{
